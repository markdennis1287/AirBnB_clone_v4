$(document).ready(function() {
    ...
    // Original 3-hbnb.js functionality for handling amenities
    ...
    // Fetch places on button click based on selected amenities
    $('button').click(function() {
        fetchPlaces(selectedAmenities);
    });

    // Initial load of places without filtering
    fetchPlaces();
});
